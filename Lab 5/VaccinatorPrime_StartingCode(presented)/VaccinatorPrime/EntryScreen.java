    ...
    public VaccineBatch getVaccineBatch(Scanner scan)
    {
        ...
        */
        ...
        try{
            ...
            System.out.println("Please Enter Preference:");
            int preference = Integer.parseInt(scan.nextLine());
            System.out.println("Enter Vaccine Contra Indicators: ");
            String cIndicators = scan.nextLine();
            vb = new VaccineBatch(name, size, preference, cIndicators);
