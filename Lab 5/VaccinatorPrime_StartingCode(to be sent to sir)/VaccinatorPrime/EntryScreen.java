...
*/
    ...
    public VaccineBatch getVaccineBatch(Scanner scan) 
    {
        ...
        */
        ...
        VaccineBatch vb = new VaccineBatch(inputArray[0], Integer.parseInt(inputArray[1]), Integer.parseInt(inputArray[2]), inputArray[3]);
        //Complete code to accept vaccinebatch from screen
        return vb;
